...
export default function MainPengaturan() {
    ...
    const editPassword = async (e) => {
        ...
        try {
            ...
            setBerhasil("Password berhasil diubah");
            setErrorMsg("");
        } catch (error) {
        ...
        <div className="col-span-12 md:col-span-8 lg:col-span-7 transition duration-300 ease-in">
            <div className="bg-white p-5 rounded shadow">
                ...
                <form onSubmit={editPassword}>
                    ...
                    <input type="password" value={passwordLama} onChange={(e) => setPasswordLama(e.target.value)} id="password-lama" placeholder='Masukan Password Lama' className='w-full bg-gray-100 p-3' />
                    <label for="password-baru" className='text-gray-700'>Password Baru</label>
                    <input type="password" value={passwordBaru} onChange={(e) => setPasswordBaru(e.target.value)} id="password-lama" placeholder='Masukan Password Baru' className='w-full bg-gray-100 p-3' />
