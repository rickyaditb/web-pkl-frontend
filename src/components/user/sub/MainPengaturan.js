        ...
        <div className="col-span-12 md:col-span-8 lg:col-span-7 transition duration-300 ease-in mb-24">
            {props.menu === "main" ?
                <div className="bg-white p-5 rounded shadow">
                    <div className='font-bold text-gray-600 text-xl flex items-center gap-2 mb-4 pb-3 border-b-2 border-gray-200 cursor-pointer' onClick={() => { props.setMenu("email") }}>
                    ...
                    <div className='font-bold text-gray-600 text-xl flex items-center gap-2 mb-4 pb-3 border-b-2 border-gray-200 cursor-pointer' onClick={() => { props.setMenu("telepon") }}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                    ...
                    <div className='font-bold text-gray-600 text-xl flex items-center gap-2 cursor-pointer' onClick={() => { props.setMenu("password") }}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                ...
                <div>
                    <div className="bg-white rounded shadow px-5 py-3 mb-3 text-gray-700 font-semibold hidden md:flex">
                        ...
                        <p className="my-auto flex items-center gap-1">
                            <p onClick={() => { props.setMenu("main") }} className="cursor-pointer">Pengaturan</p>
                    ...
                    <div className="bg-white rounded shadow px-5 py-3 mb-3 text-gray-700 font-semibold flex md:hidden cursor-pointer" onClick={() => { props.setMenu("main") }}>
