                    ...
                    <div className="bg-white p-3 rounded-lg shadow flex flex-col gap-3">
                        <div className="bg-white text-gray-600 font-bold rounded-lg flex">
                            ...
                            <div className="border-l-2 pl-2 my-auto">
                                <p className="text-xs text-gray-500">Status Laporan</p>
                                <p className="text-lg -mb-1">Belum Ditinjau</p>
                            </div>
                        </div>
                        <div className="bg-white text-gray-600 font-bold rounded-lg flex">
                        ...
                        <div className="bg-white text-gray-600 font-bold rounded-lg flex">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 my-auto mr-2 shrink-0 bg-purple-300 text-white p-2 rounded-lg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1H8a3 3 0 00-3 3v1.5a1.5 1.5 0 01-3 0V6z" clip-rule="evenodd" />
                                <path d="M6 12a2 2 0 012-2h8a2 2 0 012 2v2a2 2 0 01-2 2H2h2a2 2 0 002-2v-2z" />
                            </svg>
                            <div className="border-l-2 pl-2 my-auto whitespace-nowrap text-ellipsis">
                                <p className="text-xs text-gray-500">Lampiran Berkas</p>
                                <p className="text-lg -mb-1 truncate">Tidak Ada</p>
                            </div>
                        </div>
                    </div>
                </div>
