                ...
                <table class="text-left table-auto w-full">
                    <thead>
                        <tr class="text-gray-500">
                            ...
                            <th class="font-semibold p-3">Tanggal Laporan</th>
                            <th class="font-semibold p-3 text-center">Status</th>
                    ...
                    <tbody>
                        {laporan.map((item, index) => (
                            <tr class="text-gray-900 border-t hover:bg-gray-100" key={item._id}>
                                ...
                                <td class="p-3">{moment(item.tanggal_laporan).format('dddd, Do MMMM YYYY')}</td>
                                <td class="p-3">
                                    <div className="flex justify-center items-center">
                                        <Link to={`/laporan/detail/${item._id}`} class="p-2 font-semibold leading-tight text-blue-700 bg-blue-100 text-sm rounded flex justify-center items-center">
                                ...
                                <td class="p-3">
                                    <div className="flex justify-center gap-2">
                                        <Link to={`/laporan/edit/${item._id}`} class="p-2 font-semibold leading-tight text-yellow-700 bg-yellow-100 text-sm rounded flex justify-center items-center">
                                        ...
                                        <button onClick={() => konfirmasi(item._id)} class="p-2 font-semibold leading-tight text-red-700 bg-red-100 text-sm rounded flex justify-center items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
