        ...
        <div className="col-span-12 lg:col-span-10">
            <div className="bg-white shadow rounded p-5 mb-10">
                ...
                <form className="mt-3" action="laporan.html" onSubmit={saveLaporan}>
                    ...
                    <input type="date" value={tanggal_laporan} onChange={(e) => setTanggal(e.target.value)} id="gambar" name="gambar" placeholder="Masukan Isi Laporan" class="gambar-form bg-gray-100 w-full py-3 px-3 rounded-lg mb-5 focus:outline-none focus:ring-2 border-none" />
